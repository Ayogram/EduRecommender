...
def analyze_result():
    ...
    vision_prompt = (
        ...
        "Identify course titles (e.g., 'Object-Oriented Programming') and map them to their corresponding letter grades (A, B, C, D, E, F). "
        ...
        "- \"past_grades\": a dictionary mapping course names (e.g. 'Object-Oriented Programming') to string grades (A, B, C, D, E, F). Do not skip any courses listed in the transcript.\n"
